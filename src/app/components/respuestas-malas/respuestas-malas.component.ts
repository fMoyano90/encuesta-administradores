...
@Component({
  selector: 'app-respuestas-malas',
  templateUrl: './respuestas-malas.component.html',
  styleUrls: ['./respuestas-malas.component.css'],
  providers: [EncuestaService, UserService]
})
export class RespuestasMalasComponent implements OnInit {

...
@Component({
  selector: 'app-respuestas-buenas',
  templateUrl: './respuestas-buenas.component.html',
  styleUrls: ['./respuestas-buenas.component.css'],
  providers: [EncuestaService, UserService]
})
export class RespuestasBuenasComponent implements OnInit {
